...
IC_ROSTER = [
    ...
    },
    {
        ...
        "system": (
            ...
            "3. KEY LEVELS: Support / resistance and Fibonacci retracements anchored to the 52W High and 52W Low from AUTHORITY DATA.\n"
            "   FIBONACCI FORMULA (mandatory — no shortcuts or approximations):\n"
            "     level = 52W_High − (52W_High − 52W_Low) × ratio\n"
            "     Ratios: 0.236, 0.382, 0.500, 0.618, 0.786\n"
            "   Example: high=60,000 low=40,000 → 50% = 60,000 − 20,000×0.5 = 50,000\n"
            "   Sanity check: every level MUST be between 52W_Low and 52W_High. "
            "If any level < 52W_Low or > 52W_High you have a formula error — recalculate.\n"
